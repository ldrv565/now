...
function meshFromShape(body) {
  ...
  for (let l = 0; l < body.shapes.length; l += 1) {
    ...
    switch (shape.type) {
      ...
      case CANNON.Shape.types.PLANE: {
        ...
        const ground = new THREE.Mesh(geometry, currentMaterial);
      ...
      case CANNON.Shape.types.BOX: {
        ...
        mesh = new THREE.Mesh(boxGeometry, currentMaterial);
        break;
      }
