...
import { ConvexObjectBreaker } from 'utils/jsm/misc/ConvexObjectBreaker';
import { ConvexBufferGeometry } from 'utils/jsm/geometries/ConvexGeometry';
...
const Page = () => {
  useEffect(() => {
    ...
    AmmoLibrary().then(function(AmmoLib) {
      Ammo = AmmoLib;
